...
class Attention_UNet(nn.Module):
    def __init__(self, num_channels, num_classes, filters, output_activation='sigmoid'):
        ...
        self.att4 = GridAttentionGateLocal(Fg=filters*16, Fl=filters*8, Fint=filters*8)
        self.att3 = GridAttentionGateLocal(Fg=filters*8, Fl=filters*4, Fint=filters*4)
        self.att2 = GridAttentionGateLocal(Fg=filters*4, Fl=filters*2, Fint=filters*2)
        self.att1 = GridAttentionGateLocal(Fg=filters*2, Fl=filters, Fint=filters)
